...
### Introduction
Vector search is like "searching by vibe"—it's great for concepts but bad for exact matches. Hybrid search adds "searching by string," combining the intuition of Vectors with the precision of Keywords.
...
Here is how to combine Keyword search (BM25) and Vector search into a single "Ensemble" retriever.
...
# 1. Setup Local Vector Retriever
model_name = "sentence-transformers/paraphrase-multilingual-MiniLM-L12-v2"
embeddings = HuggingFaceEmbeddings(model_name=model_name)
vectorstore = Chroma.from_texts(
    ["Report 1: SKU-99", "Report 2: Project X"], 
...
# 3. Create the Ensemble (50/50 balance)
...
# 4. Execution
# BM25 will catch the exact "SKU-99" match
docs = ensemble_retriever.invoke("SKU-99")
